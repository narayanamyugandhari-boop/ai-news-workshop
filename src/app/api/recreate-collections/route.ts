...
export async function POST() {
  try {
    console.log('🔄 Recreating collections with proper validation...')
    ...
    try {
      ...
      console.log('🗑️  Dropped existing articles collection')
    } catch (error) {
      console.log('ℹ️  Articles collection did not exist')
    }

    try {
      await db.collection('chats').drop()
      console.log('🗑️  Dropped existing chats collection')
    } catch (error) {
      console.log('ℹ️  Chats collection did not exist')
    }
    ...
    return NextResponse.json({
      success: true,
      message: 'Collections recreated successfully with native validation',
      collections: {
        articles: {
          name: 'articles',
          count: articlesCount,
    ...
    return NextResponse.json({
      success: false,
      message: 'Collection recreation failed',
